...
async function setupDatabase() {
  try {
    ...
    const sampleTests = [
      ['Complete Blood Count (CBC)', 'Measures red blood cells, white blood cells, and platelets', 45.00, 'Blood Test', 'Fast for 8-12 hours before test', '24-48 hours'],
      ['Comprehensive Metabolic Panel', 'Measures kidney function, liver function, and blood sugar', 65.00, 'Blood Test', 'Fast for 8-12 hours before test', '24-48 hours'],
      ['Lipid Panel', 'Measures cholesterol and triglycerides', 35.00, 'Blood Test', 'Fast for 12-14 hours before test', '24-48 hours'],
      ['Thyroid Function Test', 'Measures thyroid hormone levels', 55.00, 'Blood Test', 'No special preparation required', '24-48 hours'],
      ['Urinalysis', 'Analyzes urine for various health indicators', 25.00, 'Urine Test', 'Collect first morning urine', 'Same day'],
      ['X-Ray Chest', 'Chest X-ray for lung and heart evaluation', 120.00, 'Imaging', 'No special preparation required', 'Same day'],
      ['ECG/EKG', 'Electrocardiogram for heart rhythm analysis', 85.00, 'Cardiac Test', 'No special preparation required', 'Same day']
    ];
